      ...
      <div className="h-screen flex justify-center gap-4 w-[80vw] p-4 bg-green-300">
        <div className="w-[40vw] h-[40vw]">
          <form action="" onSubmit={handleForm}>
            ...
            <div className="flex flex-col mb-10">
              ...
              >
                <div className="flex flex-col items-center gap-2">
                  ...
                  <h1 className="checked:border-green-500 border-[2px] px-3 py-2 bg-green-100 rounded-lg">
                    Sandy Soil
                  </h1>
            ...
            <input className="px-4 py-2 bg-green-200 rounded-xl italic" type="submit" value="Submit" />
          </form>
        </div>
        ...
        <div className="h-[90vh] w-1/2 bg-white rounded-lg overflow-x-hidden">
          {res ? (
            <div className="main">
              {/* ans.need */}
              <div className="elem">
                <h1 className="font-bold mt-2 ml-3">Material Required</h1>
                <ol>
              ...
              <div className="elem">
                <h1 className="font-bold ml-3">Farming Tools</h1>
                <ol>
                  {res["farming_tools"]
              ...
              <div className="elem">
                <h1 className="font-bold ml-3">Climate Conditions </h1>
                <ol>
                  {res["needs"]
                    ? keys.map((item, idx) => (
                        <li className="ml-8" key={idx}>
              ...
              <div className="elem">
                <h1 className="font-bold ml-3">Steps For Planting</h1>
                <ol>
              ...
              <div className="elem">
                <h1 className="font-bold ml-3">Fertilizer</h1>
                <ol>
                  {res?.["fertilizer"]
              ...
              <div className="elem">
                <h1 className="font-bold ml-3">Additinonal Tips</h1>
                <ol>
                  {res?.["additional_tips"]
